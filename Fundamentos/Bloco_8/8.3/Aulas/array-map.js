...
const enviarEmail = (objEmail) => {
  console.log(`Email para ${objEmail.email} com a nota ${objEmail.nota} enviado com sucesso!`);
};
...
listaDeEmails.forEach((objEmail) => enviarEmail(objEmail));
